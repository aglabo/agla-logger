...
describe('Feature: Statistics Reset', () => {
  describe('When calling resetFormatterStats with accumulated statistics', () => {
    ...
    it('Then [正常]: accumulate stats again after reset', () => {
      // Arrange: リセット後の状態
      const config = new AgLoggerConfig();
      config.setLoggerConfig({
        formatter: MockFormatter.messageOnly as AgFormatterInput,
...
describe('Feature: hasStatsFormatter Method', () => {
  describe('When calling hasStatsFormatter with various configurations', () => {
    ...
    it('Then [正常]: true for MockFormatter configurations', () => {
    ...
    it('Then [正常]: false for standard formatters', () => {
      // Arrange
      const config = new AgLoggerConfig();
      config.setLoggerConfig({ formatter: JsonFormatter });
    ...
    it('Then [正常]: transition correctly between formatter types', () => {
      // Arrange
      const config = new AgLoggerConfig();
...
describe('Feature: Error Handling and Edge Cases', () => {
  describe('When calling stats-related methods with abnormal inputs', () => {
    ...
    it('Then [エッジ]: handle undefined formatter gracefully', () => {
      // Arrange
      const config = new AgLoggerConfig();
    ...
    it('Then [異常]: reject invalid formatter configuration', () => {
      // Arrange
      const config = new AgLoggerConfig();
    ...
    it('Then [正常]: handle rapid configuration changes', () => {
      // Arrange
      const config = new AgLoggerConfig();
    ...
    it('Then [正常]: maintain independence between config instances', () => {
    ...
    it('Then [正常]: track stats with ErrorThrow formatter', () => {
      // Arrange
      const config = new AgLoggerConfig();
      config.setLoggerConfig({
        formatter: MockFormatter.errorThrow as AgFormatterInput,
    ...
    it('Then [エッジ]: allow stats access during execution', () => {
