...
describe('Feature: Plugin Formatters Integration Tests', () => {
  ...
  describe('When: using JSON formatter for structured output', () => {
    ...
    it('Then: [正常] - should handle complex data structures in JSON format', () => {
      const { mockLogger } = setupTestContext();
  ...
  describe('When: using plain formatter for readable output', () => {
    ...
    it('Then: [正常] - should concatenate multiple arguments in plain format', () => {
  ...
  describe('When: using null formatter for minimal output', () => {
    ...
    it('Then: [正常] - should suppress output at all log levels', () => {
      const { mockLogger } = setupTestContext();
  ...
  describe('When: switching formatters during execution', () => {
    ...
    it('Then: [正常] - should switch formatters correctly in E2E environment during execution', (ctx) => {
